          ...
          <form class="d-flex flex-column">
           <div class="d-flex">
             ...
             <div class="col-sm-5">
                <div class="d-flex">
                  <div class="p-2 flex-fill">
                    <button style="position:relative; width:120px ; top:29px;" type="button" class="btn btn-warning me-5" @click="upin? input_update(2) : input_update(1)"  >등록/수정</button>
                  </div>
                  <div class="p-2 flex-fill">
                    <button style="position:relative; width:120px ; top:29px;" type="button" class="btn btn-success me-5" @click="refresh"  >새로고침</button>
                  </div>
                </div>
              </div>
